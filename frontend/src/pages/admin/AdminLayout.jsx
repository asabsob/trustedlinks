...
export default function AdminLayout() {
  ...
  const navItems = [
    { to: "/admin", icon: LayoutDashboard, label: t("Dashboard", "لوحة التحكم"), end: true },
    ...
    { to: "/admin/fraud", icon: ShieldAlert, label: t("Fraud Center", "مركز الاحتيال") },
          ...
          <div className="flex items-center gap-2 overflow-hidden">
            {open && (
              <h1 className="font-semibold text-green-600 text-lg whitespace-nowrap">
                {t("Trusted Links Admin", "إدارة الروابط الموثوقة")}
              </h1>
            )}
          </div>
